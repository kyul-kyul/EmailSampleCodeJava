...
public class SendEachMail {

    public static void main(String[] args) {
        SendEachMail sas = new SendEachMail();
        sas.callSendEachEmailApi();
    }

    public void callSendEachEmailApi() {

        String url = "https://api-mail.cloud.toast.com/email/v1.4/appKeys/{APPKEY}/sender/eachMail"; // {appKey} 변경 필요
