...
public class SendAdMail {
    public static void main(String[] args) {
        SendAdMail sas = new SendAdMail();
        sas.callSendAdEmailApi();
    }

    public void callSendAdEmailApi() {
        String url = "https://api-mail.cloud.toast.com/email/v1.4/appKeys/{APPKEY}/sender/ad-mail"; // {appKey} 변경 필요
