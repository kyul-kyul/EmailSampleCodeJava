...
public class SendAuthMail {
    public static void main(String[] args) {
        SendAuthMail sas = new SendAuthMail();
        sas.callSendAuthEmailApi();
    }

    public void callSendAuthEmailApi() {

        String url = "https://api-mail.cloud.toast.com/email/v1.4/appKeys/{APPKEY}/sender/auth-mail"; // {appKey} 변경 필요
