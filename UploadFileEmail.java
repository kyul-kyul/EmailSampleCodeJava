...
public class UploadFileEmail {
    public static void main(String[] args) throws IOException{
        UploadFileEmail sas = new UploadFileEmail();
        sas.fileUploadApi();
        sas.callSendFileUploadEmailApi();
    }

    public void callSendFileUploadEmailApi() {
        ...
        fileList.add(200);                                 // 업로드 시에 확인한 ID
